...
Estos comandos se corren en el proyecto ya renombrado, no en la plantilla — salvo que quieras que el _próximo_ proyecto que arranques desde cero ya venga con esas versiones más nuevas, en cuyo caso el cambio va en `DevelopLayout`.
